...
#### Removed
- **BREAKING:** Dropped the `dssim-cpu` metric and the `dssim-core`
  dependency. The 0.2.0 metric set is exactly five entries:
  `ssim2`, `ssim2-gpu`, `butteraugli`, `butteraugli-gpu`, `zensim`.
